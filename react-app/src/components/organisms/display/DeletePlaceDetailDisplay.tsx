...
export const DeletePlaceDetailDisplay: FC<deletePlaceDetailData> = memo((props) => {
    const {contents, name, anime_title, comment, anime_id, place_id, request_place_id, request_date, user_id, user_name, latitude, longitude} = props;
    ...
    return (
        <>
            ...
            <PlaceSummaryCard name={name} title={anime_title} comment={comment} anime_id={anime_id} place_id={place_id} />
