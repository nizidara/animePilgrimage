...
export const useAdminGetPlaceList = (name?: string | null, anime_id?: string | null, region_id?: string | null, page: number = 1, page_size: number = 20) => {
    ...
    useEffect(() => {
        ...
        api.get(`${fastAPIURL}/places/list/admin?${queryName}${queryAnimeId}${queryRegionId}${queryPage}${queryPageSize}`)
        .then(response => {
