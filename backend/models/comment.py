...
class Comment(Base):
    ...
    comment_id = Column(VARBINARY(16), primary_key=True, default=lambda: uuid.uuid4().bytes, nullable=False, comment='this column is generated UUID')
...
class DeleteComment(Base):
    ...
    comment_id = Column(VARBINARY(16), ForeignKey('comments.comment_id', ondelete='CASCADE', onupdate='CASCADE'), nullable=False, comment='FK')
