...
# get anime icon
@router.get("/photo/icon/anime/{anime_id}", response_model=photo_schema.AnimeIconResponse)
async def get_anime_icon(anime_id: int):
    return photo_schema.AnimeIconResponse(anime_id=anime_id, file_name="img123")

# get place icon
@router.get("/photo/icon/place/{place_id}", response_model=photo_schema.PlacePhotoIconResponse)
async def get_place_icon(place_id: str):
    return photo_schema.PlacePhotoIconResponse(place_id=place_id, file_name="img123")

# get animephoto list
@router.get("/photo/anime/{place_id}", response_model=List[photo_schema.AnimePhotoResponse])
async def get_list_anime_photo(place_id: str):
    return [photo_schema.AnimePhotoResponse(anime_photo_id="1234", place_id=place_id, file_name="img123", user_id=None)]

# get realphoto list
@router.get("/photo/real/{place_id}", response_model=List[photo_schema.RealPhotoResponse])
async def get_list_real_photo(place_id: str, comment_id: str = None):
...
# post anime icon
@router.post("/photo/icon/anime", response_model=photo_schema.AnimeIconResponse)
...
# post place icon
@router.post("/photo/icon/place", response_model=photo_schema.PlacePhotoIconResponse)
...
# post anime photo
@router.post("/photo/anime", response_model=photo_schema.AnimePhotoResponse)
...
# post real photo
@router.post("/photo/real", response_model=photo_schema.RealPhotoResponse)
...
# update anime icon
@router.put("/photo/icon/anime/{anime_id}", response_model=photo_schema.AnimeIconResponse)
async def uodate_anime_icon(anime_id: int, file_name: str):
    return photo_schema.AnimeIconResponse(anime_id=anime_id, file_name=file_name)

# update place icon
@router.put("/photo/icon/place/{place_id}", response_model=photo_schema.PlacePhotoIconResponse)
...
@router.delete("/photo/anime/{anime_photo_id}")
async def delete_anime_photo():
    pass

# delete place photo file DB
@router.delete("/photo/real/{real_photo_id}")
async def delete_anime_photo():
    pass